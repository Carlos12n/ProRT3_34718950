...
<!-- navegacion -->
<nav class="seccion-oscura navbar navbar-expand-lg" style="background-color: #345067;">
    <div class="container">
        <a class="navbar-brand" href="<?php echo base_url('principal') ?>">
            <!-- logo de la empresa -->
            <!-- <img src="<?php echo base_url('assets/img/principal.jpg') ?>" alt="logo" width="75" height="30" class="img-fluid"> -->
            <img src="assets/img/principal.jpg" alt="logo" width="75" height="30" class="img-fluid rounded-logo" >
